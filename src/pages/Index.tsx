...
const Index = () => {
  ...
  const handleExecuteRebalance = async () => {
    try {
      ...
      // Refresh portfolio data after successful rebalance
      portfolio.refetch();
    } catch (error) {
          ...
          <div className="text-center py-20">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                The future of decentralized portfolio management powered by advanced AI algorithms.
                Optimize your DeFi investments with intelligent rebalancing on BNB Chain.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="glass-card p-6 hover:scale-105 transition-transform">
                  ...
                  <p className="text-gray-400 text-sm">
                    Advanced machine learning algorithms analyze your portfolio and market conditions
                  </p>
                </div>
                ...
                <div className="glass-card p-6 hover:scale-105 transition-transform">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">Smart Rebalancing</h3>
                  <p className="text-gray-400 text-sm">
                    Automated portfolio optimization through secure smart contract execution
                  </p>
                </div>
                ...
                <div className="glass-card p-6 hover:scale-105 transition-transform">
                  ...
                  <p className="text-gray-400 text-sm">
                    Comprehensive market data and portfolio insights updated in real-time
                  </p>
                </div>
              </div>
              ...
              >
                {wallet.isConnecting ? 'Connecting...' : 'Connect Wallet to Get Started'}
              </button>
            </div>
          </div>
        ) : (
